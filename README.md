# END OF LIFE FOR 1.12.2
The Midnight for 1.12.2 will no longer be updated. If you desperately want to send in a pull request to fix some crucial bugs, feel free to do so, but Cryptic Mushroom will not be updating this version of the mod any time soon. This branch continues to exist *solely* for historical purposes. **Please do not post any issues relating to the 1.12.2 version of The Midnight. You can count on it being closed.**
