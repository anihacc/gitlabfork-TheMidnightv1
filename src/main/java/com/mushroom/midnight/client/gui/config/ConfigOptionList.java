...
public class ConfigOptionList extends AbstractOptionList<ConfigOptionList.Row> {
    ...
    protected void renderHoleBackground(int top, int bottom, int topAlpha, int bottomAlpha) {
        ...
        minecraft.getTextureManager().bindTexture(AbstractConfigScreen.MN_BACKGROUND_LOCATION);
    ...
    public static class Row extends AbstractOptionList.Entry<Row> {
        ...
        protected final AbstractConfigScreen screen;
        protected List<String> tooltip;

        private final List<IGuiEventListener> children;

        public Row(String label, Widget widget, AbstractConfigScreen screen) {
            this.label = label;
            this.widget = widget;
            this.screen = screen;
            if (widget != null) {
    ...
    public static class ButtonOnlyRow extends Row {
        ...
        public ButtonOnlyRow(Widget widget, AbstractConfigScreen screen) {
            super("", widget, screen);
        }
    ...
    public static class HeaderRow extends Row {
        ...
        public HeaderRow(String label, AbstractConfigScreen screen) {
