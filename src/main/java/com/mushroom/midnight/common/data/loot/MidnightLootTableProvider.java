...
public abstract class MidnightLootTableProvider extends LootTableProvider {
    ...
    public MidnightLootTableProvider(DataGenerator dataGeneratorIn) {
    ...
    protected void writeTables(DirectoryCache cache, Map<ResourceLocation, LootTable> tables) {
