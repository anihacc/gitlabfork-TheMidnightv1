...
public abstract class AbstractMidnightTreeFeature<T extends IFeatureConfig> extends Feature<T> {
    ...
    public AbstractMidnightTreeFeature(Function<Dynamic<?>, ? extends T> configFactoryIn) {
    ...
    public AbstractMidnightTreeFeature<T> setSapling(net.minecraftforge.common.IPlantable sapling) {
