...
public class EntranceRiftPieces {
    ...
    public static class Piece extends StructurePiece {
        ...
        public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPosIn) {
            riftGenerator = new EntranceRiftGenerator(worldIn);

            riftGenerator.generate(new BlockPos(this.boundingBox.minX + 10, this.boundingBox.minY, this.boundingBox.minZ + 10), randomIn);
