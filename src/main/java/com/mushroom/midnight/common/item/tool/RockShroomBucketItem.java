...
//                            return ActionResult.resultSuccess(itemstack1);
                            return ActionResult.newResult(ActionResultType.SUCCESS, itemstack1);
                        }
                    }
...
//                        return ActionResult.resultSuccess(this.emptyBucket(itemstack, playerIn));
                        return ActionResult.newResult(ActionResultType.SUCCESS, this.emptyBucket(itemstack, playerIn));
                    } else {
//                        return ActionResult.resultFail(itemstack);
                        return ActionResult.newResult(ActionResultType.FAIL, itemstack);
                    }
